...
class _PlanApiService implements PlanApiService {
  _PlanApiService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  }) {
    baseUrl ??= 'http://10.0.2.2:5000/api/plans';
  }
  ...
  Future<List<PlanModel>> getPlans() async {
    ...
    final _options = _setStreamType<List<PlanModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
